...
# theoretically work). Searches through all subfolders. Unreadable files
# are ignored
path='/media/HD3/database_alparray'
...
statfilepath = '/media/HD3/database_alparray/statlist.txt' # 3 columns: station_id latitude longitude

# OPTIONAL: folder where the station inventory files are stored (to get station location information)
inventory_directory = "/media/HD3/SwathD/station_inventory" # xml inventory files

# path where the cross correlation spectra should be saved
spectra_path='/media/HD3/cross_correlation_spectra_3hrs'
...
database_file = '/media/HD3/database_alparray/database.sqlite'


# check if there are new files in the path. The sqlite database is then updated
update_database = False # recommended to be True

# check the 'statfilepath' file for new station files. A station file will
# be created if it does not exist yet. recommended to be True
update_statlist = False # recommended to be True
...
window_length=3*3600. # in seconds
...
save_monthly = True # will require more disk space if set to True
...
only_process_these_stations = None#['OE.KBA','OE.ABTA']
